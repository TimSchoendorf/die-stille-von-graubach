...
def _add_act3_allies_choice(tr):
    ...
    _t(tr, F, "elise_final_thought",
       en="Tomorrow is the day. I will stand above the thinnest stone, sing the chant Hilde taught me, and hear whether the thing below answers as a prisoner... or as an equal.",
