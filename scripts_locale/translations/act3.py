...
def _add_act3_allies_choice(tr):
    ...
    _t(tr, F, "voss_ally_4", en="And if it goes wrong... I hold the line while you finish the rite. No more feeding others to it. Not again.", fr="Et si celà tourne mal... alors j'irai en premier. Je le dois à Friedrich Meier. Je le dois à tous.", es="Y si sale mal... entonces yo iré primero. Se lo debo a Friedrich Meier. Se lo debo a todos.", it="E se va storto... allora vado per primo. Lo devo a Friedrich Meier. Lo devo a tutti.")
