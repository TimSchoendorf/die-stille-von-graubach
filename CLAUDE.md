...
JSON-basiertes Dialogsystem, Flag-System für Branching, 6 Enden.
...
## Konventionen
- GDScript, snake_case
- Signale für lose Kopplung zwischen Systemen
- Pfade: res://assets/, res://data/, res://scenes/, res://scripts/
- Display: 1920x1080, canvas_items stretch

## Asset-Pipeline
- Chars: Animagine XL 3.1 (Oil Painting), 832x1216 → rembg (isnet-anime) → 600x900
- BGs: juggernautXL, 1344x768 → 1920x1080
- SD API: http://127.0.0.1:7860
- Generierungsskript: scripts_sd/generate_all_characters_v2.py
- Pose-Lock + white BG + CFG 7, KEIN "dark atmosphere" im Prompt
